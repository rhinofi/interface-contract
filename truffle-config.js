...
module.exports = {
  ...
  networks: {
    ...
    ropsten: {
      provider: () => new HDWalletProvider(NMEMONIC, `https://ropsten.infura.io/v3/${PROJECT_ID}`),
    ...
    goerli: {
      provider: () => new HDWalletProvider(NMEMONIC, `https://goerli.infura.io/v3/${PROJECT_ID}`),
